...
WebUI.waitForElementPresent(findTestObject('Page_UP Portal  HoChiMinh University of Pedagogy/td_Mt m truy cp khng chnh xc'), 
    10)

WebUI.verifyElementText(findTestObject(null), 'Mật mã truy cập không chính xác')
